          ...
          <table id="myTable" class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?=$s->nama_daerah?></td>
                  <td><?php
                    $image = [	'src'	=> 'assets/img/gambar/' . $s->gambar,
                              'height'	=> '100'
                              ];
                    echo img($image)
                  ?></td>
                  ...
                  <?php } else { ?>
                    <?=anchor(	'admin/confirm_submissions/'.$s->id,
                              ' Confirm ', 
                              ['class'=>'btn btn-success btn-sm',
                              'onclick'=>'return confirm(\'Konfirmasi Pengajuan Data?\')'])
                              
                    ?> <?=anchor(	'admin/reject_submissions/'.$s->id,
                              'Tolak', 
                              ['class'=>'btn btn-danger btn-sm',
                              'onclick'=>'return confirm(\'Toalak Pengajuan Data?\')'])
                    ?>
                    <?php } ?>
                  </td>
                </tr>
